...
export default function HealthChecklistScreen() {
  ...
  const fetchHealthData = async () => {
    try {
      ...
      // RBAC: Check if employee has access to health checklist
      if (!isManagerRole(u.role) && !(u.assigned_checklists || []).includes('health')) {
        Alert.alert(
          'Access Denied',
          'You are not assigned to the Health checklist.',
